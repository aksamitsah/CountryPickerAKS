...
class CountryModelList {
    ...
    func getLocalCountryOnTop(data countryList: [CountryList]) -> [CountryList]{
        ...
        var localCountry = countryList.filter{ $0.code == ccode}
        localCountry.append(contentsOf: countryList.filter{ $0.code != ccode})
        return localCountry
    ...
    private func dataList() -> [CountryList]? {
        ...
        guard let jsonData = jsonCountryData.data(using: .utf8) else { return nil }
